...
function onloadShoppingDetailPage() {
  document.getElementById('clip').addEventListener('click', toggleClip);
  document.getElementById('fit_follow_y').addEventListener('click', toggleFollowBrand);
  document.getElementById('fit_follow_n').addEventListener('click', toggleFollowBrand);
    ...
    switch (parsedData.type) {
      case 'ynData': {
        ...
        if (hideBrandFollowButton) {
          document.getElementById('fit_follow_y').style.display = 'none';
          document.getElementById('fit_follow_n').style.display = 'none';
        } else if (followYn === 'Y') {
          document.getElementById('fit_follow_y').style.display = 'block';
          document.getElementById('fit_follow_n').style.display = 'none';
        } else if (followYn === 'N') {
          document.getElementById('fit_follow_y').style.display = 'none';
          document.getElementById('fit_follow_n').style.display = 'block';
        }

        // 클립 버튼 Y/N 여부는 하기 코드에서 컨트롤함.
        if (clipYn === 'Y') {
          document.getElementById('clip').classList.add('on');
        } else if (clipYn === 'N') {
